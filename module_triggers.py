...
##diplomacy end
# AI UNIVERSAL POLLING
  # Checks once per second. Works in Castles, Towns, and the World Map.
 # AI UI OPENER
# --- TEST TRIGGER: PRESS B TO OPEN BOX (WORLDMAP + INDOOR) ---
# Press 'B' to toggle the AI screen
# AI Everywhere Listener
